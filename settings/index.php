  ...
  <body>
    <div class="container mt-3 mb-5">
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="mb-2 row">
          <label for="username" class="col-md-2 col-form-label text-nowrap fw-medium">Username :</label>
          <div class="col-md-10">
            <input type="text" name="username" class="form-control fw-bold text-white" value="<?php echo $user['username']; ?>">
          </div>
        </div>
        <div class="mb-2 row">
          <label for="password" class="col-md-2 col-form-label text-nowrap fw-medium">Password :</label>
          <div class="col-md-10">
            <input type="password" name="password" class="form-control fw-bold text-white" value="<?php echo $user['password']; ?>">
          </div>
        </div>
        <div class="mb-2 row">
          <label for="bio" class="col-md-2 col-form-label text-nowrap fw-medium">Bio :</label>
          <div class="col-md-10">
        ...
        <div class="mb-2 row">
          <label for="born" class="col-md-2 col-form-label text-nowrap fw-medium">Born :</label>
          <div class="col-md-10">
            <input type="date" name="born" class="form-control fw-bold text-white" value="<?php echo $user['born']; ?>">
          </div>
        </div>
        <div class="mb-2 row">
          <label for="region" class="col-md-2 col-form-label text-nowrap fw-medium">Region :</label>
          <div class="col-md-10">
            <input type="text" name="region" class="form-control fw-bold text-white" value="<?php echo $user['region']; ?>">
          </div>
        </div>
        <div class="mb-2 row">
          <label for="picture" class="col-md-2 col-form-label text-nowrap fw-medium">Profile Picture :</label>
          <div class="col-md-10">
            <input type="file" name="profile_picture" class="form-control fw-bold text-white">
          </div>
        </div>
        <div class="mb-2 row">
          <label for="background" class="col-md-2 col-form-label text-nowrap fw-medium">Background :</label>
          <div class="col-md-10">
        ...
        <?php for ($i = 1; $i <= 10; $i++) : ?>
          <div class="mb-2 row">
            <label for="link<?php echo $i; ?>" class="col-md-2 col-form-label text-nowrap fw-medium">Link <?php echo $i; ?> :</label>
            <div class="col-md-10">
